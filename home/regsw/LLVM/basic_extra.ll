...
define dso_local noundef signext i32 @main() local_unnamed_addr #0 {
  tail call void asm sideeffect "add n20, n3, n4", ""() #2, !srcloc !6
  tail call void asm sideeffect "li n6, 3", ""() #2, !srcloc !7
  tail call void asm sideeffect "li n7, 6", ""() #2, !srcloc !8
  %1 = tail call i32 asm sideeffect "add $0, n6, n7", "=r"() #2, !srcloc !9
  %2 = tail call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef signext %1)
  ret i32 0
}
